...
import { ThreeMedias } from "../../src/components/three-medias"
...
<ThreeMedias 
    mediaItems={[ 
        {type: "image", src:"https://utfs.io/f/If0ZI6Cx8kn0psbFmXH71S0y6Nv4kVYrqeUxcdOliTtEaDjm", caption:"Add notes to a shared map"}, 
        {type: "image", src:"https://utfs.io/f/If0ZI6Cx8kn0zav0biK83rdzOlXkLbchS5ExR64NGAD0JeV7", caption:"QR code to share map with friends"}, 
        {type: "image", src:"https://utfs.io/f/If0ZI6Cx8kn0XPD6CnJsu1azjpSfL7vKUEnQ98thTcIwldOV", caption:"Add multiple places to the map at once"} 
    ]}
/>
...
<div className="flex justify-center">
    <img className="border-2 border-border rounded-md" src="https://utfs.io/f/If0ZI6Cx8kn06y4qCcAgQPnWGmOsouMCVdtkYDILrq9z87xN" width="600" alt="My team during Hack Together." />
</div>
