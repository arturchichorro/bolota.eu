...
<div className="flex justify-center">
    <video className="border-2 border-border rounded-md" width="350" controls>
        <source src="/assets/demo_bballvision.mp4" type="video/mp4" />
...
<div className="flex justify-center">
    <img className="border-2 border-border rounded-md" src="/assets/bballvision_png.png" width="600" alt="Explanation of made shot logic" />
</div>
### Future Improvements
