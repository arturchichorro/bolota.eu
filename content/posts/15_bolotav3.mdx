...
import ConnectFour from "../../src/components/connect-four/connect-four"
import { ProjectItem } from "../../src/components/project-item"
import SudokuAlgX from "../../src/components/sudoku/SudokuAlgX"

## One Year Later

The last time I wrote about <a href="/" className="link">bolota.eu</a> was July 2024, over a year ago. Since then, I kept making small tweaks to it, and together they added up to some pretty significant changes from how the website used to be.
...
To do that, I used a platform called <a className="link" href="https://www.mailerlite.com/" target="_blank">MailerLite</a>. It handled the basics well: managing a list of subscribers, making it easy to unsubscribe, sending emails to everyone at once, and providing a clear dashboard with stats on opens, clicks, and more. The subscription form described here has since been retired.
...
Adding to that, I've generally been getting more used to embedding components in blog posts using MDX. I'm particularly happy with the visualizations of the Sudoku algorithms, from <a href="14_algxsudoku" className="link">this</a> post.
...
And the Connect Four "chess.com" like UI from <a className="link" href="9_connect4">this</a> post.
